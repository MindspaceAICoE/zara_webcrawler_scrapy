...
class ZaraSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.zara.com/in/en/man-tshirts-l855.html?v1=2297854",
                  "https://www.zara.com/in/en/woman-tshirts-l1362.html?v1=2290973"]
    ...
    def parse_product_page(self, response):
        ...
        # # Pass product data to MongoDB pipeline
        # yield {'item': product_data}